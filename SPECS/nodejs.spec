...
%nodejs_define_version node 1:24.19.0-%{autorelease} -p
...
0001-update-sqlite-to-3.53.4.patch
# npm patches
0001-deps-npm-tar-fix-CVE-2026-59873-CVE-2026-59874.patch
0001-CVE-2026-69192-CVE-2026-54272-ip-address-10.4.0.patch
0001-CVE-2026-69152-brace-expansion-5.0.9.patch
...
* Tue Aug 18 2026 tjuhasz <tjuhasz@redhat.com> - 1:24.19.0-1
- Update to version 24.19.0

* Thu Aug 06 2026 tjuhasz <tjuhasz@redhat.com> - 1:24.18.0-6
- Update brace-expansion from 5.0.6 to 5.0.9 to address CVE-2026-13149
  (memory exhaustion via deeply chained brace groups). as well as
  CVE-2026-14257 (fixed in 5.0.8).

* Wed Aug 05 2026 tjuhasz <tjuhasz@redhat.com> - 1:24.18.0-5
- Fix for CVE-2026-69192 & CVE-2026-54272 : ip-address

* Mon Aug 03 2026 Andrei Radchenko <aradchen@redhat.com> - 1:24.18.0-4
