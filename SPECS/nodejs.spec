...
%nodejs_define_version node 1:24.14.1-2%{?dist} -p
...
%if %{with bootstrap}
%bcond_without  all_deps_bundled
%else
%bcond_with     all_deps_bundled
%endif
...
# This NodeJS streams need at least python 3.8
...
BuildRequires:  python3.8dist(setuptools), python3.8dist(jinja2)
...
Patch0003: 0003-downstream-update-nghttp2-to-1.68.1.patch
...
BuildArch:      noarch
# Rough equivalent of more modern Requires(meta): nodejs = %%{node_evr}
Conflicts:      nodejs < %{node_evr}
Conflicts:      nodejs > %{node_evr}
...
# === Upstream test suite
# Informational for now; differences in OpenSSL versions are expected to break some tests
...
%changelog
* Tue Apr 07 2026 Jan Staněk <jstanek@redhat.com> - 1:24.14.1-2
- Update bundled nghttp2 to 1.68.1
  Related: RHEL-151374

* Tue Apr 07 2026 Jan Staněk <jstanek@redhat.com> - 1:24.14.1-1
- Update to 24.14.0
  Resolves: RHEL-151374

* Wed Jan 14 2026 Andrei Radchenko <aradchen@redhat.com> - 1:24.13.0-1
- Update to 24.13.0
  Resolves: RHEL-135257

* Thu Sep 04 2025 Jan Staněk <jstanek@redhat.com> - 1:24.4.1-1
